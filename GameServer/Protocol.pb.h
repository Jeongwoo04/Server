...
// repeated .Protocol.BuffData buff = 4;
inline int S_TEST::_internal_buff_size() const {
  return buff_.size();
}
inline int S_TEST::buff_size() const {
  return _internal_buff_size();
}
inline void S_TEST::clear_buff() {
  buff_.Clear();
}
inline ::Protocol::BuffData* S_TEST::mutable_buff(int index) {
  // @@protoc_insertion_point(field_mutable:Protocol.S_TEST.buff)
  return buff_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::BuffData >*
S_TEST::mutable_buff() {
  // @@protoc_insertion_point(field_mutable_list:Protocol.S_TEST.buff)
  return &buff_;
}
inline const ::Protocol::BuffData& S_TEST::_internal_buff(int index) const {
  return buff_.Get(index);
}
inline const ::Protocol::BuffData& S_TEST::buff(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.S_TEST.buff)
  return _internal_buff(index);
}
inline ::Protocol::BuffData* S_TEST::_internal_add_buff() {
  return buff_.Add();
}
inline ::Protocol::BuffData* S_TEST::add_buff() {
  // @@protoc_insertion_point(field_add:Protocol.S_TEST.buff)
  return _internal_add_buff();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::BuffData >&
S_TEST::buff() const {
  // @@protoc_insertion_point(field_list:Protocol.S_TEST.buff)
  return buff_;
}
